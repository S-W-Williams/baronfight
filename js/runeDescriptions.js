const runeDescriptions = {
    ...
    8124: {
        ...
        baronfight: "Gain an Active (Press the '3' key to activate!): Dash - Channel for 3 seconds (You cannot take any actions while channeling) then triple clearing speed for 20 seconds. This cannot be cast while already in effect."
    },
    8126: {
    ...
    8313: {
        ...
        baronfight: "Gain an active (Press the '4' key to activate!): Stasis - You cannot make any actions but you cannot be damaged for 10 seconds. Cooldown: 45 seconds."
    },
    8316: {
        league: "Start game with 6 minion dematerializers, killing an enemy minion for free",
        baronfight: "Start each round with 10 dematerializers. Activate (Press the '5' key to activate!) them to destroy any orb on your field."
    },
    8321: {
